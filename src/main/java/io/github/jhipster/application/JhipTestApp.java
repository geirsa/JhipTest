...
public class JhipTestApp {

    private static final Logger log = LoggerFactory.getLogger(JhipTestApp.class);

    private final Environment env;

    public JhipTestApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes JhipTest.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipTestApp.class);
